...
const aboutData = [
  ...
  },
  {
    ...
    description: `כל הליווי שצריך כדי לרכוש נכס בדובאי ללא תשלום נוסף.
רגולציה, אישורים, פתיחת חשבון בנק, העברת כספים, ליווי עו"ד וראיית חשבון, רישום בטאבו. אנחנו מטפלים בהכל.`,
  },
  {
  ...
  },
  {
    ...
    label: "בדובאי ובארץ",
    description:
      "לרשותך צוות מקצועי, דובר עברית, עם שלוחה בישראל וצוות מקומי בדובאי. ליווי מלא מהפגישה הראשונה ועד לניהול הנכס בפועל.",
  },
];
