...
export default function ThankYouPage() {
  return (
    ...
    // <header className="thank-you-page ">
    //   <video
    //     className="video-background"
    //     loop
    //     muted
    ...
    //       <div className="logo-placeholder">הכניסי כאן את הלוגו</div>
    //     </div>
    ...
    //         <h2 className="info-title">השלב הבא</h2>
    //         <p className="info-text">
    //           הפרטים שלכם התקבלו בהצלחה. נציג מטעמנו יצור איתכם קשר תוך 24 שעות
    //           לייעוץ אישי והצגת הזדמנויות השקעה מותאמות לצרכיכם הספציפיים בשוק
    //           הנדל"ן בדובאי.
    //         </p>
    //         <h3 className="contact-title">צריכים לדבר איתנו עכשיו?</h3>
    //         <p className="contact-text">
    //           אנו זמינים עבורכם לכל שאלה או הבהרה נוספת
    //         </p>
    //       </div>
    //     </div>
    //   </div>
